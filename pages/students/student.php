...
<body>
    ...
    <div class="container">
        ...
        <section>
            <a style="padding-left: 40px; width: 100%; background-color: #fff; position: sticky; z-index: 1; top: 80px; margin-top: -40px; color: #16855a; font-size: 20px;" href="./add.php">Add New Student</a>

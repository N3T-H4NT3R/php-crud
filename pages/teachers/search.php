...
if (isset($_GET["query"])){
    ...
    $sql = "SELECT * FROM teachers WHERE fullname LIKE '%$query%'";
...
<body>
    ...
    <div class="container">
        ...
        <section>
            <a style="padding-left: 40px; width: 100%; background-color: #fff; position: sticky; z-index: 1; top: 80px; margin-top: -40px; color: #16855a; font-size: 20px;" href="./teacher.php">Back</a>

            <header>
                <h2>Filtered Teacher</h2>
